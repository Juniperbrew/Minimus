...
public class Network {
    ...
    static public void register (EndPoint endPoint) {
        ...
        kryo.register(Component.Position.class);
        kryo.register(Component.Health.class);
        ...
        kryo.register(Component.Rotation.class);
        kryo.register(Component.Team.class);
        kryo.register(Component.Slot1.class);
        kryo.register(Component.Slot2.class);
        kryo.register(Component.MaxHealth.class);
